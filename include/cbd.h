...
/* A FAIREEEEEEEEEEEEEEEEEE */

/* Algorithme 13 */

void sample_NTT(poly_t* f, uint8_t seed[34]);

void sample_poly_cbd_eta2(poly_t* f, int8_t seed[128]);

void sample_poly_cbd_eta3(poly_t* f, int8_t seed[192]);
